...
- Contribution
  - [PR] [awslabs/video-on-demand-on-aws](https://github.com/awslabs/video-on-demand-on-aws/pull/99)
...
- 주요 작업기능 :
  ...
  * 기개발된 OpenCV 영상 처리 소스를 iOS앱에 연동(Realtime Camera view 및 Image Edit 에 적용)
  * 기존 1:1 크롭툴에 기능 추가(4:3 / 3:4 toggle crop)
  * OpenCV 를 사용하여, 360도 촬영 된 물체의 Top Estimate 된 형태를 이미지로 만들어내는 코드 추가(개발된 좌우보정 알고리즘을 베이스로 나온 선으로 된 이미지를 OpenCV 로 가공하는 추가 작업)
  * 인앱결제 추가
